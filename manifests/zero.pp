...
define cvmfs::zero (
  ...
  file { ["${spool_store}/${repo}/cache",
      "${spool_store}/${repo}/rdonly",
      "${spool_store}/${repo}/scratch",
      "${spool_store}/${repo}/tmp",
      "${spool_store}/${repo}/scratch/current",
    "${spool_store}/${repo}/scratch/wastebin"]:
      ensure => directory,
      owner  => $user,
      group  => $group,
  }
